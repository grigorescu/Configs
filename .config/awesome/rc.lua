...
function run_script()
    local filedescriptor = io.popen('timeout 1s /home/vladg/.config/awesome/spotify.py')
...
vicious.register(spotify, run_script, "$1", 3)
...
globalkeys = awful.util.table.join(
    ...
    -- Spotify
    awful.key({ modkey }, "F12", function() exec("dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Next") end),
